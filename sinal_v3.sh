...
echo "Foi identificado que o MAC "$mac" está chegando no slot 19 da FiberHome, OLT Valentina." 
echo "Obs.: Não é possível identificar o nível de sinal das SFP's, através do software ANM2000."            
echo 
echo "Número do chamado:"
read  num
echo
echo "Atendimento "$num": Nível de sinal."
echo
exit
fi 
